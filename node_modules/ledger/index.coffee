...
class Ledger
    ...
    squash: (ops, from_idx=0) ->
        ...
        if first_op.opcode != "del_purchase"
                ...
                switch last_op.opcode
                    when "del_purchase"
                        if first_op.opcode == "add_purchase"
                            ...
                            new_slice = [{id: uniqueId(), opcode: last_op.opcode, payload: last_op.payload}]
                    when "chg_purchase"
                        if first_op.opcode == "add_purchase"
                            new_slice = [{id: uniqueId(), opcode: first_op.opcode, payload: last_op.payload}]
                        else
                            new_slice = [{id: uniqueId(), opcode: last_op.opcode, payload: last_op.payload}]
                    else
            ...
            idx = 0
            squashed = []
        return a.slice(0, from_idx).concat @squashed(slice, 1)
        ...
        switch op.opcode
            when "del_purchase"
                ...
                for idx, p of @people
                    ...
                    delete p.purchases[purchase.id]
